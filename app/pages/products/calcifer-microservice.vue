  ...
  <div class="min-h-screen bg-background">
    ...
    <section class="relative min-h-[85vh] flex flex-col items-center justify-center px-6 overflow-hidden">
      ...
      <div class="relative z-10 text-center max-w-5xl mx-auto">
        ...
        <h1 class="text-5xl sm:text-6xl md:text-7xl font-black tracking-tighter mb-6 text-balance opacity-0 animate-fade-in-down" style="animation-delay: 0.1s">
          Calcifer.Microservice<br />
          <span class="text-fire-400">.API.Template</span>
        </h1>

        <p class="text-xl text-muted-foreground font-light mb-4 max-w-2xl mx-auto opacity-0 animate-fade-in-down" style="animation-delay: 0.2s">
          Not a template. A control system for your SaaS.
        </p>
        ...
        <p class="text-base text-foreground/60 max-w-2xl mx-auto mb-12 leading-relaxed opacity-0 animate-fade-in-down" style="animation-delay: 0.3s">
          A .NET 8 microservice template with built-in licensing, feature gating, and seat control —
          so you can ship SaaS like a product, not just code.
        </p>

        <!-- CTA Buttons -->
        <div class="flex flex-col sm:flex-row gap-4 justify-center opacity-0 animate-fade-in-up" style="animation-delay: 0.4s">
          <Button size="lg" @click="scrollTo('pricing')" class="px-8 bg-fire-500 hover:bg-fire-600 text-white border-0 glow-pulse">
            📦 Get Calcifer
          </Button>
          <Button size="lg" variant="outline" class="px-8 border-border hover:border-fire-500/50" @click="openLink('https://www.nuget.org/packages/Calcifer')">
            📦 NuGet Gallery
          </Button>
          <Button size="lg" variant="outline" class="px-8 border-border hover:border-fire-500/50" @click="openLink('https://github.com/calcifer-shop/calcifer')">
            🐙 GitHub
          </Button>
        </div>
      ...
      <div class="max-w-5xl mx-auto">
        ...
        <div class="grid sm:grid-cols-3 gap-4 mb-12">
          <div v-for="(step, idx) in flowSteps" :key="idx"
            ...
            <div v-if="idx < flowSteps.length - 1" class="hidden sm:block absolute top-1/2 -right-2.5 text-fire-400/50 text-lg">→</div>
          </div>
        </div>
        ...
        <div class="grid lg:grid-cols-2 gap-6">
          ...
          <div class="rounded-2xl border border-fire-500/20 overflow-hidden glow-card">
            ...
            <pre class="rounded-none! border-0! m-0!"><code class="text-sm text-fire-200">{{ responseBody }}</code></pre>
          </div>
        </div>
      </div>
    </section>
    ...
    <section id="architecture" class="py-28 px-6 bg-card/20">
      <div class="max-w-5xl mx-auto">
        ...
        <!-- Architecture flow -->
        <div class="flex flex-wrap items-center justify-center gap-3 mb-16 p-6 rounded-2xl border border-border/50 bg-background">
        ...
        <div class="mt-16 pt-16 border-t border-border">
          ...
          <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
            <div v-for="(value, key) in specs" :key="key"
    ...
    <section class="py-28 px-6">
      <div class="max-w-5xl mx-auto">
        <p class="text-fire-400 text-sm font-semibold uppercase tracking-widest mb-4">Why Calcifer?</p>
      ...
      <div class="max-w-5xl mx-auto">
        ...
        <div class="grid md:grid-cols-3 gap-6">
          ...
          <div class="p-8 rounded-2xl border border-border bg-card hover:border-fire-500/30 transition-all duration-300">
            ...
            <p class="text-4xl font-black mb-1">$49</p>
            ...
            <Button class="w-full" variant="outline" @click="scrollTo('pricing')">
              Get Solo
            </Button>
          </div>

          <!-- Studio (Featured) -->
          <div class="p-8 rounded-2xl border-2 border-fire-500 bg-card relative hover:-translate-y-1 transition-all duration-300 glow-card">
            ...
            <p class="text-4xl font-black mb-1 text-fire-400">$149</p>
            <p class="text-xs text-muted-foreground mb-8">one-time</p>
            <ul class="space-y-3 mb-8 text-sm">
            ...
            <Button class="w-full bg-fire-500 hover:bg-fire-600 text-white border-0" @click="scrollTo('pricing')">
              Get Studio
            </Button>
          </div>
          ...
          <div class="p-8 rounded-2xl border border-border bg-card hover:border-fire-500/30 transition-all duration-300">
            ...
            <p class="text-4xl font-black mb-1">$499</p>
            <p class="text-xs text-muted-foreground mb-8">one-time</p>
            <ul class="space-y-3 mb-8 text-sm">
        ...
        <div class="flex flex-col sm:flex-row items-center justify-center gap-4 mt-16">
          <Button variant="outline" size="lg" class="gap-2" @click="openLink('https://github.com/calcifer-shop/calcifer')">
            <i class="fab fa-github"></i>
            ⭐ Star on GitHub
          </Button>
          <Button variant="outline" size="lg" class="gap-2" @click="openLink('https://www.nuget.org/packages/Calcifer')">
            📦 Install from NuGet
          </Button>
        </div>
      </div>
...
useHead({
  title: 'Calcifer.Microservice.API.Template — Control Who Uses Your Software',
  meta: [
    {
      name: 'description',
