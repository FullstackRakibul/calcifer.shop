<template>
  <div class="min-h-screen bg-background">
    ...
    <section class="relative min-h-screen flex flex-col items-center justify-center px-6 overflow-hidden">
      ...
      <div class="relative z-10 text-center max-w-4xl mx-auto">
        ...
        <div class="absolute bottom-8 left-1/2 -translate-x-1/2 animate-bounce">
          ...
          <div class="mt-2">
            <HugeiconsIcon :icon="ArrowDown01Icon" :size="20" class="text-muted-foreground animate-pulse" />
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="relative py-20 px-6">
      <div class="max-w-7xl mx-auto">
        <img 
          ...
          :alt="product.name" 
          class="w-full h-96 sm:h-125 object-cover rounded-2xl shadow-2xl"
        />
      </div>
    </section>
          ...
          <div class="space-y-4">
            ...
            >
              <div class="shrink-0 mt-1">
                <HugeiconsIcon :icon="Tick01Icon" :size="20" class="text-accent" />
              </div>
    ...
    <section id="preorder-section" class="py-32 px-6 bg-linear-to-b from-background to-muted/30">
...
import { ArrowDown01Icon, Tick01Icon, ShoppingCart01Icon } from '@hugeicons/core-free-icons'
